...
function CadastroUsuario() {
    ...
    return (
        <Grid container direction='row' justifyContent='center' alignContent='center' className="CadastroCor">
            <Grid item xs={6} className='' >
                <Box>
                <img className='imagem2' src="https://i.pinimg.com/474x/4d/1d/b8/4d1db8baf1f2aa92b334da3003da73e7.jpg"/>
                </Box>
            </Grid>
